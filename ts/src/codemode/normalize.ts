// Vendored from @cloudflare/codemode — code normalization for LLM output
// Original: https://github.com/cloudflare/agents/blob/main/packages/codemode/src/normalize.ts
